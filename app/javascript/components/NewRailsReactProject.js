  ...
  return (
    <div className="container">
      <div className="flex-column p-sm">
        ...
        <h6 className='is-size-6'>Step 1) Create the project</h6>
        ...
        <h6 className='is-size-6'>Step 2) Install relevant components</h6>
        ...
        <h6 className='is-size-6'>Step 3) Add Webpack script</h6>
            ...
            {`
{
  ...
  "scripts": {
    "start": "./bin/webpack-dev-server"
        ...
        <h6 className='is-size-6'>Step 4) Start server</h6>
        ...
        <h6 className='is-size-6'>Step 5) Add some rails stuff</h6>
...
create  app/assets/stylesheets/homepages.scss
        ...
        <h6 className='is-size-6'>Step 6) Add some rails stuff</h6>
...
Find me in app/views/homepages/index.html.erb
        ...
        <h6 className='is-size-6'>Step 7) Setup React in Rails</h6>
...
<%= javascript_pack_tag 'index' %>
        ...
        <h6 className='is-size-6'>Step 8) Create some React files</h6>
  ...
  if (reactElement) {
    if (window.railsEnv && window.railsEnv === 'development') {
      ...
      render(<App />, reactElement)
        ...
        <h6 className='is-size-6'>Step 9) We’re getting closer to fixing the app I made you break. </h6>
...
<div id="app">
        ...
        <h6 className='is-size-6'>Step 10) Homestretch I swear</h6>
